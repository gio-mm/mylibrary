    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="{{url('admin')}}" class="easion-logo"><i class="fas fa-sun"></i> <span>My Library</span></a>
            </header>
                    ...
                    <i class="fas fa-home"></i> Dashboard </a>
                        ...
                        <div class="dash-nav-dropdown">
                            <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                                <i class="fas fa-sticky-note"></i> Books </a>
                                <div class="dash-nav-dropdown-menu">
                                    <a href="/admin/book/create" class="dash-nav-dropdown-item">
                                        <i class="far fa-plus-square mr-2"></i> Add Book</a>
                                    </div>
                                    <div class="dash-nav-dropdown-menu">
                                        <a href="/admin/book" class="dash-nav-dropdown-item">
                                            <i class="fas fa-plus-circle mr-2"></i>All Books</a>
                                        </div>
                                    </div>
